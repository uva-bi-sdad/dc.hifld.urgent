---
title: "prepare data - urgent medical services - catchment_scores"
author: "--"
date: "2/4/2022"
...
provider <- sf::st_read(
  ...
  query= "
SELECT  *
FROM dc_health_behavior_diet.ncr_pl_hifld_2021_urgent_care "
)
...
#write
write.csv(provider, "urgent_care.csv" )
```

# load data
```{r}
provider <- read.csv("urgent_care.csv", row.names = 1)
...
#prepare data for save: SELECT relevant variables. 
```{r}
